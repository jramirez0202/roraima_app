...
Rails.application.configure do
  ...
  # STAGING ENVIRONMENT
  # =========================================
  # Este ambiente simula producción pero con algunas configuraciones
  # más permisivas para facilitar testing y debugging.
  #
  ...
  # Store uploaded files on AWS S3 (staging bucket)
  # El rol IAM asignado al contenedor ECS proporciona credenciales automáticamente
  ...
  # En staging usamos debug por defecto para facilitar troubleshooting
  ...
  config.active_job.queue_name_prefix = "roraima_app_staging"
