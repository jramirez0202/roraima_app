...
ORD-001,Juan Pérez,912345678,Av. Providencia 123,Providencia,Paquete con ropa,15000,NO,cliente@empresa.com
```

**Nota:** La fecha de carga se asigna automáticamente al día de hoy.

**Para Customers:**
```
NRO DE PEDIDO,DESTINATARIO,TELÉFONO,DIRECCIÓN,COMUNA,DESCRIPCIÓN,MONTO,CAMBIO,EMPRESA
ORD-001,Juan Pérez,912345678,Av. Providencia 123,Providencia,Paquete con ropa,15000,NO,Mi Empresa
```
...
**Nota:** La columna FECHA fue eliminada. Todos los paquetes se crean con la fecha actual automáticamente.
...
- ✅ **Fecha de carga se asigna automáticamente al día de hoy**
